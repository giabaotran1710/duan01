document.addEventListener('DOMContentLoaded', function () {
    ...
    const games = [
        ...
        { id: 'gamecaro', name: 'Cờ Caro', diff: '3/5', genre: 'chien-thuat' },
        { id: 'memori', name: 'Ghi nhớ màu sắc', diff: '3/5', genre: 'tri-tue' },
        { id: 'magic', name: 'Tìm bóng', diff: '3/5', genre: 'tri-tue' },
        { id: 'crab', name: 'Chặn cua', diff: '2/5', genre: 'chien-thuat' },
        { id: 'reversi', name: 'Reversi', diff: '2/5', genre: 'chien-thuat' },
        { id: 'domin', name: 'Minesweeper', diff: '5/5', genre: 'tri-tue' },
        { id: 'haichien', name: 'Hải chiến', diff: '3/5', genre: 'chien-thuat' },
        { id: 'musicgame', name: 'Nhịp điệu âm nhạc', diff: '4/5', genre: 'hanh-dong' },
        { id: 'nedan', name: 'Né đạn', diff: '5/5', genre: 'hanh-dong' },
        { id: 'ghinho', name: 'Ghi nhớ Emoji', diff: '4/5', genre: 'tri-tue' },
        { id: 'thaphaycao', name: 'Thấp hay cao', diff: '2/5', genre: 'giai-tri' },
        { id: 'codam', name: 'Cờ đam', diff: '2/5', genre: 'chien-thuat' },
        { id: 'neonreflex', name: 'Neon Reflex', diff: '5/5', genre: 'hanh-dong' },
        { id: 'dapquai', name: 'Đập quái rừng sâu', diff: '4/5', genre: 'hanh-dong' },
        { id: 'unogame', name: 'UNO!', diff: '1/5', genre: 'giai-tri' },
        { id: 'sieuduoibat', name: 'Siêu đuổi bắt', diff: '5/5', genre: 'hanh-dong' },
        { id: 'hungbi', name: 'Hứng bi', diff: '4/5', genre: 'hanh-dong' },
        { id: 'duaxucxac', name: 'Đua xúc xắc bãi biển', diff: '1/5', genre: 'giai-tri' },
        { id: 'blockjump', name: 'Nhảy! Nhảy và nhảy!', diff: '4/5', genre: 'hanh-dong' },
        { id: 'bidaBtn', name: 'Bida', diff: '4/5', genre: 'the-thao' },
        { id: 'khinhkhi', name: 'Khinh khí cầu', diff: '3/5', genre: 'giai-tri' },
        { id: 'xepbonggai', name: 'Xếp bóng gai', diff: '2/5', genre: 'tri-tue' },
        { id: 'truottuyet', name: 'Trượt tuyết', diff: '3/5', genre: 'the-thao' },
        { id: 'demsao', name: 'Quan sát chòm sao', diff: '2/5', genre: 'tri-tue' },
        { id: 'bongnay', name: 'Bóng nảy', diff: '4/5', genre: 'hanh-dong' },
        { id: 'echnhayho', name: 'Ếch nhảy hồ', diff: '5/5', genre: 'tri-tue' },
        { id: 'comet', name: 'Trốn khỏi thiên thạch', diff: '5/5', genre: 'hanh-dong' },
    ];
    ...
    function renderGames(genre) {
        ...
        filtered.forEach((game, index) => {
            ...
            infoDiv.innerHTML = `
                ...
                <span class="game-genre">${getGenreName(game.genre)}</span>
